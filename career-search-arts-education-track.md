# Career Search — Arts Nonprofit Community Engagement & Education Track
**Maxwell Perkins**
**Started: September 8, 2026**

Sub-track of `career-search-ops-track.md`. Same underlying experience (Sprout Society), different
altitude and vocabulary. Target roles: hourly/associate-level community engagement and education
program coordinator positions at arts nonprofits (orchestras, museums, theaters, arts education
nonprofits). Reference posting: Wisconsin Chamber Orchestra, Community Engagement & Education
Associate, $19-20/hr, 30 hrs/week, reports to a manager.
...
- `career-search-ops-track.md` targets personal-assistant/studio-manager roles. Voice: business
  owner's right hand.
- This track targets program-coordinator roles that report to a manager and are front-line facing
  toward families, participants, and site partners, with heavy database/CRM ownership.
- Same facts. The ops-track resume leads with executive support and the revenue pivot. This one
  leads with program coordination, database accuracy, and youth/family communication.

---

## The Overqualification Problem

The gap: Max ran the strategy, finances, sales, and every operational hat at Sprout Society. The
target role is an hourly, non-exempt associate seat with a manager above it, focused on day-to-day
program delivery and front-line family communication. Read at full altitude, the resume signals a
director candidate applying for a coordinator job, which reads as flight risk, not as strength.

**The fixes:**

1. **Use the real title.** "Community Manager," not "Operations Manager." It is accurate and it
   already sits closer to the target role's register.
2. **Control altitude in the language.** Drop "strategic," "business analysis," "revenue model,"
   "sales," and "founder" framing from the lead bullets. Replace with "coordinate," "maintain,"
   "respond to," "support," "assist." Same facts, lower register.
3. **Keep the membership win, shrink it, move it down.** It is real proof of initiative, but it is
   the most C-suite-sounding line on the resume. One line, near the bottom, not the headline.
4. **Sequence bullets by the job posting's own priority order**, not by what feels most impressive.
   WCO lists program operations and family communication first at 90% of the role; community
   events and partnerships second at 10%. Mirror that order.
5. **Soft-pedal the internal AI tools.** Per the hard rule in `career-search-ops-track.md`, default
   to omitting "AI" branding for traditional arts/nonprofit roles. Translate the outcome into plain
   language: kept records accurate, cut manual data entry, retired subscriptions no longer needed.
   Use it only to back up a stated JD need (here: "proficiency in database or CRM tools; comfort
   learning new systems quickly"), not as a headline achievement.
6. **Cut signals of upward career-track ambition from this version.** PMP-in-progress and "Founder"
   both signal a candidate aiming at a director track, which raises the same flight-risk flag.
   Omit or minimize for this track.
7. **Never explain the overqualification in the letter.** Do not write "I know this is a step
   down" or anything adjacent. Volunteering the caveat is what draws attention to it. Let the
   resume's altitude do the work silently.
8. **If asked directly in an interview**, answer with the real, positive reason: hands-on
...
## Proof Points, Reframed for This Track
...
> Dear WCO Hiring Team,
>
> After almost ten years in New York City, I'm relocating to Madison. In that decade I earned a
> master's in music composition, taught piano, drums, audio production, and composition, performed
> regularly around the city, and planned events across culinary, music, comedy, and art scenes.
> That range is exactly what led me to Sprout Society.
>
> Sprout Society is a nonprofit community space for creatives in Brooklyn, and I was brought on to
> grow its membership from the ground up. I plan, manage, and host a monthly music and art
> showcase, help members run their own events in the space, lead social media and community
> outreach, support our grant applications, and build the tools and workflows that keep all of it
> running efficiently.
>
> In two months, that work took the space from zero active members to five who are now building
> their own communities inside it. What started as one showcase a month has grown into ten to
> fifteen community events a month, drawing fifty to a hundred new people through the door.
>
> That's the kind of growth WCO is asking for: real community building, tracked and repeatable, not
> just activity. I plan and measure engagement systematically because I want to see what's working,
> and as a music educator I understand exactly what students and families need from a program like
> Super Strings.
>
> I've built most of this alone, out of necessity more than preference. I'd rather build it with a
> team pursuing the same mission, and WCO looks like that team. I'd welcome the chance to talk about
> how I can help.
>
> Best,
> Maxwell Perkins
...
- [ ] Check the Overture Education & Community Engagement coordinator role by hand.
- [ ] Madison Community Foundation Office Coordinator: apply this week if interested.
